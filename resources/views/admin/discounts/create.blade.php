...
<div class="container">
    ...
    <!-- Formulir untuk membuat diskon baru -->
    <form action="{{ route('admin.discounts.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" name="percentage" id="percentage" class="form-control @error('percentage') is-invalid @enderror" value="{{ old('percentage') }}" min="0" max="100" step="0.01" required>
            @error('percentage')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
